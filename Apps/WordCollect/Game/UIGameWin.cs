...
public class UIGameWin : UIViewPop, ISegmentDelegate
{
    ...
    protected override void Awake()
    {
        ...
        Common.SetButtonText(btnNext, Language.main.GetString("STR_GameWin_BtnNext"), 32, true);
        Common.SetButtonText(btnAddLove, Language.main.GetString("STR_GameWin_BtnAddLove"), 32, true);

        string str = info.title;
        if (Common.BlankString(str) && (!Common.BlankString(info.id)))
        {
    ...
    {
        WordItemInfo infoGuanka = GameLevelParse.main.GetItemInfo();
        infoItem = infoGuanka;
        string str = "";
        ...
        /* 
                       if (Common.appKeyName == GameLevelParse.STR_APPKEYNAME_XIEHOUYU)
                       {
                           str = infoGuanka.head + "\n" + infoGuanka.end;
                       }
