...
namespace GameVanilla.Game.Scenes
{
    public class UIGameCandyMatch : UIGameBase
    {
        ...
        public override void UpdateGuankaLevel(int level)
        {
            ...
            gameCandyMatch.gameUi = gameUi;
            gameCandyMatch.ingameBoosterPanel = ingameBoosterPanel;
            gameCandyMatch.ingameBoosterText = ingameBoosterText; 
