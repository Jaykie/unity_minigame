...
public class UIHomeCandyMatch : UIHomeBase, IPopViewControllerDelegate
{
    ...
    public void UpdateMusicSoundBtn()
    {
        ...
        if (btnMusic != null)
        {
            TextureUtil.UpdateButtonTexture(btnMusic, (music == 0) ? AppRes.IMAGE_BtnMusicOff : AppRes.IMAGE_BtnMusicOn, false);
        }
        ...
        if (btnSound != null)
        {
            TextureUtil.UpdateButtonTexture(btnSound, (sound == 0) ? AppRes.IMAGE_BtnSoundOff : AppRes.IMAGE_BtnSoundOn, false);
        }
