...
namespace GameVanilla.Game.UI
{
    ...
    public class LevelButton : MonoBehaviour
    {
        ...
        public void GotoGame()
        {
            ...
            NaviViewController navi = GuankaViewController.main.naviController;
            navi.Push(GameViewController.main);//  GuankaViewController GameViewController
        }
        public void OnStartGamePopupDidPlay()
        {

            Invoke("GotoGame", 0.6f);
            StartGamePopup.main.callbackPlay = null;
        }
        //@moon
