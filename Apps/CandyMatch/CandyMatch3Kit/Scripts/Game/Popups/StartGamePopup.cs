...
public delegate void OnStartGamePopupDidPlayDelegate();
namespace GameVanilla.Game.Popups
{
    ...
    public class StartGamePopup : Popup
    {
        ...
        //@moon
        public OnStartGamePopupDidPlayDelegate callbackPlay { get; set; }
        static private StartGamePopup _main = null;
        public static StartGamePopup main
        {
            get
            {
                if (_main == null)
                {
                    _main = new StartGamePopup();
                }
                return _main;
            }
        }
        ...
        public void OnPlayButtonPressed()
        {
            ...
            //@moon
            // if ((_main != null) && (_main.callbackPlay != null))
            // if (_main != null)
            {
                if (_main.callbackPlay != null)
                {
                    Close();
                    _main.callbackPlay();
                    return;
