...
namespace GameVanilla.Game.Scenes
{
    ...
    public class LevelScene : BaseScene
    {
        ...
        private void Start()
        {
            ...
            Debug.Log("LevelScene: nextLevel=");
            if (PuzzleMatchManager.instance.unlockedNextLevel)
            {
                Debug.Log("LevelScene: unlockedNextLevel");
                foreach (var button in scrollView.GetComponentsInChildren<LevelButton>())
                {
                    Debug.Log("LevelScene: button.numLevel="+button.numLevel+" lastSelectedLevel="+PuzzleMatchManager.instance.lastSelectedLevel);
